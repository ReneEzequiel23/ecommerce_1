            ...
            <div id="containerPg" class="contenido">
                <div class="tarjeta-producto">
                    ...
                    <form id="formularioEditar">
                        ...
                        <button type=\"button\" class=\"btn-crear\" style=\"background-color: #6c757d; margin-top:10px;\" onclick=\"window.location.href='gestionarCatalogoProductos.jsp'\">Cancelar</button>
                    </form>
